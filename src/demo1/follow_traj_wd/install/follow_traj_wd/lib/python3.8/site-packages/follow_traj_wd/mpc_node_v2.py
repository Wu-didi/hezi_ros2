...
from follow_demo_mpc_bank_black import VehicleTrajectoryFollower
...
def main(args=None):
    ...
    main_trajectory_csv = '/home/nvidia/vcii/follow_trajectory/collect_trajectory/processed_nal1225_with_yaw_ck.csv'
