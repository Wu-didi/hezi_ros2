...
class TrajectoryPublisher(Node):
    def __init__(self):
        ...
        # 读取 CSV 初始轨迹
        csv_file_path = '/home/nvidia/vcii/follow_trajectory/collect_trajectory/processed_nal1225.csv'
        ...
        #=============================下面是mpc================================
        mpc_trajectory_csv = '/home/nvidia/vcii/follow_trajectory/collect_trajectory/processed_nal1225_with_yaw_ck.csv'
        ...
        self.MPCfollower = AdjustTrajectory(self.main_traj_data,
                                            self.second_traj_data,
    ...
    def timer_callback(self):
        ...
        MPCcurrent_traj_data = self.MPCfollower.current_trajectory
        self.publish_mpc_trajectory(MPCcurrent_traj_data)
    ...
    def obstacle_callback(self, msg):
        ...
        if len(obstacle_list) == 0:
            ...
            self.adjust_trajectory(obstacle_list_utm)
    ...
    def adjust_utm_trajectory(self, obstcle):    
        # 在这里也可以做一些判断
        # 判断是否调整轨迹
        self.MPCfollower.check_and_switch_utm_trajectory(obstcle,safe_distance=self.safe_distance)
